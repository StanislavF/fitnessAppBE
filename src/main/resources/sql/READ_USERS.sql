SELECT * 
FROM `user` 
WHERE (:username_flag=1 OR usr_username LIKE :usr_username)
  AND (:first_name_flag=1 OR usr_firstname LIKE :usr_firstname)
  AND (:last_name_flag=1 OR usr_lastname LIKE :usr_lastname)
